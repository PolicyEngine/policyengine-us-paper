...
exclusion register. For the certified Build~J release, every gate was
enforced with no bypass flags: export-mass parity passed with 0 of 35
columns out of band, and the reform-coverage smoke scored the SSI
\$10k/\$20k resource-limit probe at +\$5.15 billion
(+\$5{,}153{,}370{,}118 recorded at the gate) -- nonzero, which is the
failure mode that gate exists to block.
\evidence{\url{https://github.com/PolicyEngine/populace/issues/368},
certification verdict comment (2026-07-10): ``export-mass parity (35
columns) PASS 0/35''; ``reform-coverage smoke (SSI probe) PASS +\$5.15B'';
shipped-default comment: ``SSI \$10k/\$20k probe +\$5{,}153{,}370{,}118
enforced at the gate''}

The Build~M certification campaign (in progress at this revision)
exercised the battery at full scale; three of its stops, each resolved on
