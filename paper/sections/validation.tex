...
parity, fail-closed target-materialization guards, the take-up law gates
(Section~\ref{sec:takeup}), and reviewed exclusion registers for
zero-support cells and tail concentration. For the certified Build~O
attempt~1 release -- the first to pass every gate on its first attempt
-- and for Build~N before it, every gate was enforced with no bypass flags: all 8 build gates
passed; export-mass parity passed with zero failures on both legs
(base-frame-versus-reference and export-versus-base-frame); the
reform-coverage smoke ran 39 of 39 probes green, including the Keogh
neutralization probe under the selection-mass protection of
populace\#445/\#446 -- nonzero on a bound reform being the failure mode
that gate exists to block; and the take-up machinery, rebuilt between
Builds M and N as a single seeded Bernoulli draw at ledger-fact priors
(populace\#477 deleted the M-era count-matching reconciliation loop),
reported zero law violations on the shipped record. Build~M's
corresponding verdict was 0 of 30 parity columns out of band, +\$5.35
billion on the SSI \$10k/\$20k probe, and +\$118.1 million on Keogh;
Build~J's was 0 of 35 columns and +\$5.15 billion on the SSI probe.
\evidence{\url{https://github.com/PolicyEngine/populace/issues/368},
Build~O attempt~1 verdict (2026-07-23) and Build~N verdict (2026-07-22):
``all 8 build gates passed''; ``export-mass parity: 0 failures on both
legs''; ``reform-coverage smoke'' green; ``\texttt{bernoulli\_law\_%
violation\_count = 0}''; Build~M verdict comment (2026-07-17) for the M
figures}

The preceding Build~M certification campaign (completed 2026-07-17, sixteen
