...
zero-support cells and tail concentration. For the certified Build~N
release, every gate was enforced with no bypass flags: all 8 build gates
...
Build~N certification verdict comment (2026-07-22): ``all 8 build gates
passed''; ``export-mass parity: 0 failures on both legs'';
``reform-coverage smoke: PASS 39/39 probes'';
``\texttt{bernoulli\_law\_violation\_count = 0}''; Build~M verdict
comment (2026-07-17) for the M figures}
