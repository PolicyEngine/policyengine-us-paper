...
For the currently certified US release -- Build~M, release id
\texttt{populace-us-2024-buildm-sparse-rmloss100-98bf731-20260717T075101Z},
certified 2026-07-17 against \policyengineus{} 1.764.6 -- the
certification verdict records a final calibration loss of 0.026655 and
90.2\% of the registry's 5{,}667 compiled targets within 10\% relative
error, with every release gate enforced and no bypass flags
(Section~\ref{sec:release-gates}). It supersedes Build~J
(\texttt{75d5add-20260710T094201Z}: 0.030843, 89.0\%, 5{,}510 targets)
-- a better fit on a larger target surface.
\evidence{\url{https://github.com/PolicyEngine/populace/issues/368},
certification verdict comment (2026-07-17): final loss 0.026655;
within-10\% 0.9021; 5{,}667 compiled specs;
\texttt{release\_gates.passed=True}, \texttt{failures=[]}}
...
The currently certified default is the Build~M bundle: the dataset's
\texttt{latest.json} points to
\texttt{populace-us-2024-buildm-sparse-rmloss100-98bf731-20260717T075101Z},
published 2026-07-17 as an immutable tagged publish and certified for
consumption through \policyenginepy{}.
\evidence{\url{https://github.com/PolicyEngine/populace/issues/368},
Build~M certification verdict comment (2026-07-17): ``SHIPPED as the
certified US default: latest.json ->
populace-us-2024-buildm-sparse-rmloss100-98bf731-20260717T075101Z'';
certification wiring in PolicyEngine/policyengine.py\#475}
